...
- **Bone Tools**  
  ...
  - Batch bone renaming with auto recognition (simply checks the names of bones if they correspond to at least one of skeleton standart specified in the script: VRM, SFM, Rigify, MMD English, XNA Lara, DAZ Poser, 3DS Max, Type X, Bepu, Sims 2)
